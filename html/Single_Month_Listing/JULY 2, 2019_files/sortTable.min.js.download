...
if(bJ=="alert"){}else{throw new Error(bM)
...
aw("columns().footer()","column().footer()",function(bI,bJ){return this.iterator("column",function(bL,bK){return bL.aoColumns[bK].nTf
})
});
...
$(document).ready(function(){$(".wpsm-sortableTable").dataTable({paging:false,ordering:true,info:true});
$(".wpsm-sortableTable").show()
});